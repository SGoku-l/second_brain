        ...
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <header class="glass-panel flex flex-col gap-4 rounded-[26px] px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <nav class="flex flex-wrap items-center gap-1 text-sm">
                    ...
                    <a href="{{ route('admin.repos') }}" @class(['rounded-full px-3 py-1.5 transition', 'bg-sb-accent/10 font-semibold text-sb-accent' => request()->routeIs('admin.repos*'), 'text-stone-500 hover:text-stone-900 dark:text-stone-400 dark:hover:text-stone-100' => ! request()->routeIs('admin.repos*')])>Repos</a>
